...
function ListaFornecedores({ filtroNome }) {
  ...
  const filtrados = fornecedores
    .filter((f) => {
      const termo = filtroNome ? filtroNome.toLowerCase() : "";
    ...
    <>
      ...
      <div className={styles.listaClientesGrid}>
        ...
        <div className={styles.clientesLista}>
          {filtrados.length === 0 ? (
            <p style={{ padding: "20px", color: "#6b7280", textAlign: "center" }}>Nenhum fornecedor encontrado</p>
          ) : (
...
function ListaClientes({ filtroNome }) {
  ...
  const filtrados = clientes
    .filter((c) => {
      const termo = filtroNome ? filtroNome.toLowerCase() : "";
      return c.razaoSocial?.toLowerCase().includes(termo);
    })
    .sort((a, b) => {
      const { campo, direcao } = ordenacao;
      let valorA, valorB;
  ...
  return (
    <>
      ...
      <div className={styles.listaClientesGrid}>
        ...
        <div className={styles.clientesLista}>
          {filtrados.length === 0 ? (
            <p style={{ padding: "20px", color: "#6b7280", textAlign: "center" }}>Nenhum cliente encontrado</p>
          ) : (
            filtrados.map((c, index) => (
              ...
              >
                <div className={styles.clienteItem}>
                  ...
                  <span className={styles.clienteTabela}>{c.tabelaPreco?.nomeTabela || "-"}</span>
                  <div className={styles.clienteEdicao}>
      ...
      <div className={styles.cabecalho}>
        ...
        <div className={styles.cabecalhoLayoutNovo}>
          ...
          <button className={styles.toggleBtnUnico} onClick={alternarVisao}>
            {visao === "fornecedores" ? "Ver Clientes" : "Ver Fornecedores"}
          </button>
